...
| `pmt.ensembling` | Temporal stacking framework: four-window base/meta/calibrate/evaluate splits, an anti-leakage guard that rejects base models trained beyond their window, and a hook for custom meta-features. |
...
python examples/04_stacking_demo.py         # temporal stacking + leakage guard
